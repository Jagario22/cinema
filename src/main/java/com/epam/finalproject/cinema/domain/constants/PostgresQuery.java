...
public class PostgresQuery {
    ...
    public final static String SELECT_TITLE_FROM_FILMS = "select (id, title) from films";
    public final static String SELECT_USER_BY_LOGIN_AND_PASSWORD = "select * from users where login = ? AND password = ?";
    public final static String SELECT_ALL_CURRENT_FILMS = "select f.* from films as f  INNER JOIN sessions ON f.id = sessions.id " +
